...
console.log(downloadURL)
  ...
  const model = genAI.getGenerativeModel({
    ...
    systemInstruction: "Analise a imagem fornecida e determine qual o genero está selecionada nas caixas de seleção. A imagem mostra duas caixas de seleção, uma rotulada como \"MACHO\" e a outra como \"FEMEA\". Uma das caixas está marcada responta em JSON: \n{\n \"text\": \"campo selecionado\"\n}",
  });
